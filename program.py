...
class MyApp(ShowBase):
	...
	def __init__(self):
		...
		#self.sliderText = OnscreenText(self.textTitle,style=1, fg=(1,1,1,1), pos=(0,0), scale = .1)
		self.txtStats = OnscreenText(self.textTitle,style=1, fg=(1,1,1,1), pos = (0,0,0), scale = 0.1)
		self.drawUI()
